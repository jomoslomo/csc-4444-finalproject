...
const wss = new WebSocketServer({ port: 8081 }); // initiate a new server that listens on port 8080
...
wss.on('connection', (ws) => {
    ...
    // stop tracking the client upon that client closing the connection0
    ws.on('close', () => {
